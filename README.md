...
&emsp;BitRPGを導入すると、各チャンネルに共通で初期1Lvのモンスターが出現します。一体倒すごとに1Lvずつ上昇していきます。Normalの敵は敵ごとにステータスの特徴があり、また特定の条件下で、通常よりも強かったり、経験値量が多いモンスターが出現します。※現在Normal以外の出現をカットしています。稀にUltraRareが出現しますが、攻撃が通らないので^^resetで敵を変更して引き続きお楽しみください。
&emsp;
<details>
<summary>

...
class Player:
    def __init__(self, client, id):
        ...
        self.lv, self.max_exp, self.now_exp, self.now_stp, self.str_p, self.def_p, self.agi_p, self.magic_class, self.kill_count, self.item, self.money = list(self.dtd.values())[0:]
